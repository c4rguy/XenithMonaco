import {Copilot,logger}from'@monacopilot/core';var k=n=>!n||n.length===0?"":n.length===1?n[0]:`${n.slice(0,-1).join(", ")} and ${n.slice(-1)}`;var S=(n,e,o={})=>{if(e<=0)return "";let t=n.split(`
